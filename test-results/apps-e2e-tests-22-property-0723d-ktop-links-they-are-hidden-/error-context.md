...
- Name: apps\e2e\tests\22-property-public-page.spec.ts >> Public Property Page — Mobile (375px) >> mobile nav does not show desktop links (they are hidden)
- Location: apps\e2e\tests\22-property-public-page.spec.ts:86:7
