...
- Name: apps\e2e\tests\11-property-settings.spec.ts >> Property Settings & Customizations (Subdomain / Colors) >> Cloudflare CNAME logic correctly validates external Domain availability
- Location: apps\e2e\tests\11-property-settings.spec.ts:46:7
