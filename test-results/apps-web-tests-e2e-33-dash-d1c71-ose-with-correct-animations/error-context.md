...
- Name: apps\web\tests\e2e\33-dashboard-ui-rooms.spec.ts >> Dashboard UI & Rooms Modals E2E >> Rooms slide-out panels open and close with correct animations
- Location: apps\web\tests\e2e\33-dashboard-ui-rooms.spec.ts:59:7
...
Locator: getByRole('heading', { name: 'Rooms', exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Rooms', exact: true })
