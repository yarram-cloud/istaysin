...
- Name: apps\e2e\tests\10-guest-crm-loyalty.spec.ts >> Global CRM & Identity Merging Workflow >> Twin external bookings map to unified Guest Profile entity
- Location: apps\e2e\tests\10-guest-crm-loyalty.spec.ts:24:7
