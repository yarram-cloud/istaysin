...
- Name: apps\e2e\tests\22-property-public-page.spec.ts >> Public Property Page — Mobile (375px) >> hero text is readable — h1 visible on mobile
- Location: apps\e2e\tests\22-property-public-page.spec.ts:100:7
