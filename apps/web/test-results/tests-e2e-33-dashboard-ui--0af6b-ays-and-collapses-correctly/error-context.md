...
- Name: tests\e2e\33-dashboard-ui-rooms.spec.ts >> Dashboard UI & Rooms Modals E2E >> Dashboard Sidebar navigation displays and collapses correctly
- Location: tests\e2e\33-dashboard-ui-rooms.spec.ts:16:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3100/dashboard
Call log:
  - navigating to "http://localhost:3100/dashboard", waiting until "load"
