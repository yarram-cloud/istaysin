           ...
           <div className="max-w-[1200px] mx-auto text-center">
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
               {offers.map((offer: any, i: number) => (
                 <div key={i} className="bg-white p-8 shadow-sm group hover:shadow-xl transition-shadow cursor-pointer">
         ...
         <section className="py-32 bg-[#0A0A0A] px-8 border-y border-white/5 relative">
            <div className="max-w-[1400px] mx-auto">
               ...
               <div className="grid md:grid-cols-2 gap-12">
                 {offers.map((offer: any, i: number) => (
                   <div key={i} className="flex flex-col md:flex-row bg-[#111] border border-white/10 group cursor-pointer hover:border-brand/50 transition-colors">
         ...
         <section className="py-24 bg-white px-8">
            <div className="max-w-[1200px] mx-auto">
               ...
               <div className="grid lg:grid-cols-3 gap-10">
                 {offers.map((offer: any, i: number) => (
                   <div key={i} className={`rounded-[3rem] p-8 shadow-xl ${i % 2 === 0 ? 'bg-surface-50' : 'bg-[color:var(--brand-color,#000)] text-white'}`}>
