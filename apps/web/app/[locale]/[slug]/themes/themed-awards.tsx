...
export default function ThemedAwards({ config, themeTokens }: { config: any, themeTokens: ThemeStyleMap }) {
  ...
  switch (themeTokens.templateId) {
     case 'modern-minimal':
       return (
         <section className="py-32 bg-white px-8 border-y border-surface-100">
     ...
     case 'luxury-gold':
       return (
         <section className="py-24 bg-[#0A0A0A] px-8 border-y border-brand/10">
     ...
     case 'nature-eco':
       return (
         <section className="py-24 bg-green-50 px-8">
            <div className="max-w-[1200px] mx-auto">
               <div
     ...
     case 'boutique-chic':
       return (
         <section className="py-24 bg-surface-50 px-8 border-y border-surface-200">
     ...
     case 'dark-elegance':
       return (
         <section className="py-32 bg-[#050505] px-8 relative overflow-hidden">
     ...
     case 'corporate-trust':
       return (
         <section className="py-20 bg-white px-8 border-y border-surface-200">
     ...
     case 'retro-vintage':
       return (
         <section className="py-24 bg-[#E5E0D8] border-b-[8px] border-black px-6">
            <div className="max-w-[1200px] mx-auto">
     ...
     case 'resort-tropical':
       return (
         <section className="py-20 bg-teal-50 px-8 my-10">
     ...
     case 'compact-urban':
       return (
         <section className="py-16 bg-surface-50 px-6 border-y border-surface-200">
