...
export default function GuestCheckoutPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <Link href={`/property/${params.slug}`} className="inline-flex items-center gap-2 text-primary-600 hover:text-primary-700 font-medium mb-8 transition-colors">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {step === 3 && bookingResult && (
            <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-surface-200 text-center animate-in fade-in zoom-in duration-500">
              ...
              <Link href={`/property/${params.slug}`} className="block w-full property-theme-primary property-theme-hover text-white py-4 rounded-xl font-bold transition-all">
                Return to Home
              </Link>
            </div>
          )}
