...
- Name: 22-property-public-page.spec.ts >> Public Property Page — Mobile (375px) >> mobile nav does not show desktop links (they are hidden)
- Location: tests\22-property-public-page.spec.ts:86:7
...
Locator: locator('nav.hidden')
Expected pattern: /hidden/
Error: strict mode violation: locator('nav.hidden') resolved to 2 elements:
    1) <nav class="hidden md:flex items-center gap-8 font-medium text-sm">…</nav> aka getByText('AboutRoomsAmenitiesReviews')
    2) <nav class="hidden md:flex items-center gap-8">…</nav> aka getByText('AboutRoomsGallery')

Call log:
  - Expect "toHaveClass" with timeout 30000ms
  - waiting for locator('nav.hidden')
  ...
  - generic [ref=e2]:
    - banner [ref=e3]:
      - generic [ref=e4]:
        ...
        - link "Book Now" [ref=e9] [cursor=pointer]:
                  ...
                  - generic [ref=e41]:
                    ...
                    - generic [ref=e43]:
                      - generic [ref=e44]:
                        ...
                        - text: Up to 2 guests
                      - img [ref=e49]
                    - link "Book this Room" [ref=e52] [cursor=pointer]:
              ...
              - list [ref=e158]:
                - listitem [ref=e159]:
                  - link "About" [ref=e160] [cursor=pointer]:
                    - /url: "#about"
                - listitem [ref=e161]:
                  - link "Rooms & Suites" [ref=e162] [cursor=pointer]:
                    - /url: "#rooms"
                - listitem [ref=e163]:
              ...
              - list [ref=e167]:
                ...
                - listitem [ref=e170]:
                  - link "Terms of Service" [ref=e171] [cursor=pointer]:
                    - /url: "#"
                - listitem [ref=e172]:
                  - link "Refund Policy" [ref=e173] [cursor=pointer]:
                    - /url: "#"
            - generic [ref=e174]:
    ...
    - contentinfo [ref=e181]:
      - generic [ref=e182]:
        ...
        - generic [ref=e188]:
          ...
          - list [ref=e190]:
            - listitem [ref=e191]:
              - link "Our Rooms" [ref=e192] [cursor=pointer]:
                - /url: "#rooms"
            - listitem [ref=e193]:
              - link "Guest Reviews" [ref=e194] [cursor=pointer]:
                - /url: "#reviews"
            - listitem [ref=e195]:
